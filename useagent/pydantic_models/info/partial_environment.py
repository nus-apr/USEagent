...
class PartialEnvironment:
    ...
    def get_output_instructions(cls) -> str:
        return (
            ...
            "\t - setup_command: Command to prepare the environment (e.g., install deps). Optional.\n"
            "\t - build_command: Command to build the project. Optional.\n"
            "\t - test_command: Command to run the test suite. Optional.\n"
            "\t - run_command: Command to run the application. Optional.\n"
            "\t - linting_command: Command to run linters/formatters. Optional.\n"
            "\t - reducable_test_scope: True if tests can be run in a reduced scope. Optional.\n"
            "\t - example_reduced_test_command: Example command to run a reduced test subset. Optional.\n"
            "\t - can_install_system_packages: True if the agent may install system packages. Optional.\n"
            "\t - system_package_manager: System package manager name (e.g., apt, yum, brew). Optional.\n"
            "\t - can_install_project_packages: True if the agent may install project packages. Optional.\n"
            "\t - project_package_manager: Project package manager name (e.g., pip, poetry, mvn, npm, pnpm, yarn). Optional.\n"
            "\t - other_important_commands: List of additional important commands (strings). Optional.\n"
